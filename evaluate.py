...
####################################  Load Data #####################################
# NOTE: This evaluation is performed on the ISIC 2018 validation set
# The original paper reports results on the test sets of ISIC2017, ISIC2018, and PH2
# To match the paper's reported performance, evaluation should be conducted on those test sets
